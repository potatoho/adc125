proc create_ipi_design { offsetfile design_name } {
	...
	set adc_ctrl_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:adc_ctrl:1.0 adc_ctrl_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:adc_ctrl:1.0]]]]
